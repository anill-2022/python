...
IMAGE_PATH = "E:/6 sem/escaperoom1.jpg"
WIDTH, HEIGHT = 2000, 2000
root = Tk()
root.title("The Escape Room")
root.state('zoomed')
...
canvas1.pack()
img = ImageTk.PhotoImage(Image.open(IMAGE_PATH).resize((1560, 910), Image.Resampling.LANCZOS))
...
def startBTN():
    ...
    titles_font= ("Times New Roman",20,"bold")
    normal_font = ("Times New Roman",14)
    hint_font = ("Times New Roman",12,"bold")
    voice_font=("Times New Roman",8)
    certificate_font = ("Comic Sans MS", 20, "bold")
    s0 = ttk.Style()
    s0.configure("TLabel", background='light yellow',foreground = "black")
    s0.configure("TLabelframe",background='light yellow')
    
    def intro():
        intro_LBL1=ttk.Label(terminalFrame1, text="\"I need to make friends ASAP\" you whisper to yourself while tidying your clothes in your dorm. " *1, wraplengt=1200)
        intro_LBL1.configure(font=normal_font)
        intro_LBL1.place(x=10, y=40)
        intro_LBL2=ttk.Label(terminalFrame1, text="It's your first time away from home as you've moved in to a new city to pursue college. It's just the third day at college and you being the introvert that you are haven't made friends yet." * 1, wraplengt=1200,)
        intro_LBL2.configure(font=normal_font)
        intro_LBL2.place(x=10, y=70)
        intro_LBL3=ttk.Label(terminalFrame1, text="You badly want to explore the city but are missing the quintessential friends gang. Tired of the boredom you have surrounded yourself with, you lay on your bed and start to daydream. As you are laying on the bed and scrolling through instagram, a random post about a new escape room in the city pops up in your feed." * 1, wraplengt=1200)
        intro_LBL3.configure(font=normal_font)
        intro_LBL3.place(x=10, y=115)
        intro_LBL4=ttk.Label(terminalFrame1, text="After deliberating for about 20 minutes in your mind, you finally decide to signup for a solo escape room adventure to kill the boredom blues." * 1, wraplengt=1200)
        intro_LBL4.configure(font=normal_font)
        intro_LBL4.place(x=10, y=155)
        intro_LBL5=ttk.Label(terminalFrame1, text="POV: You have arrived at the escape room facility and are asked to fill up a basic form as follows:    " * 1, wraplengt=1600)
    ...
    def rules():
        global r1, r2, r3
        r1=ttk.Label(terminalFrame1, text="1. Always click on the \'Attempt to solve\' button whenever you want to try keying in the answer or code asked." *1, wraplengt=1500)
        r1.configure(font=hint_font)
        r1.place(x=10, y=560)
        r2=ttk.Label(terminalFrame1, text="2. There are 3 chances available in each room to guess the correct answer or code. Once the 3 chances are exhausted, the room will terminate automatically." *1, wraplengt=1500)
        r2.configure(font=hint_font)
        r2.place(x=10, y=590)
        r3=ttk.Label(terminalFrame1, text="3. Be mindful to click on the next button within 10 seconds of guessing the right answer or code. On failing to do so, you may have to restart the game again." *1, wraplengt=1500)
    ...
    def detailsEntry():     
        ...
        playBTN.after(8, lambda:playBTN.place(x=250,y=400))
    ...
    def room1():
        ...
        global IMG
        IMG=ImageTk.PhotoImage(Image.open("E:/6 sem/doves_room1.jpg")) #change file path accordingly
    ...
    def room2(event):
        ...
        about1.configure(font = normal_font)
        about1.after(1000, lambda:about1.place(x=10, y=30))
        img=ImageTk.PhotoImage(Image.open("E:/6 sem/balls_room2.jpg")) #change file path accordingly
    ...
    def room3(event):
        ...
        def rightside_room3(event):
            ...
            global img1
            img1=ImageTk.PhotoImage(Image.open("E:/6 sem/hangingrope_room3.jpg")) #change file path accordingly
        ...
        def frontside_room3(event):
            ...
            global img2
            img2 =ImageTk.PhotoImage(Image.open("E:/6 sem/morsecode_room3.jpg")) #change file path accordingly
        ...
        def attempt_room3(event):
            ...
            def hint_room3(event):
                global img3
                img3=ImageTk.PhotoImage(Image.open("E:/6 sem/morsecoderef_room3.jpg")) #change file path accordingly
    ...
    def room4(event):
        ...
        def leftside_room4(event):
            ...
            global img1
            img1=ImageTk.PhotoImage(Image.open("E:/6 sem/primaballerina_room4.jpg")) #change file path accordingly
            hangingrope_img=Label(terminalFrame,image=img1)
        ...
        def rightside_room4(event):
            ...
            global img2
            img2=ImageTk.PhotoImage(Image.open("E:/6 sem/pie_room4.jpg")) #change file path accordingly
    ...
    def room5(event):
        ...
        def ledscreens(event):
            ...
            global img2
            img2=ImageTk.PhotoImage(Image.open("E:/6 sem/led_room5.jpg")) #change file path accordingly
        ...
        about1.configure(font = normal_font)
        about1.after(1000, lambda:about1.place(x=10, y=30))
        img=ImageTk.PhotoImage(Image.open("E:/6 sem/roundroom_room5.jpg")) #change file path accordingly
    ...
    def finish(event):
        ...
        global finalimg
        finalimg=ImageTk.PhotoImage(Image.open("E:/6 sem/certifcate_endWin.jpg")) #change file path accordingly
    ...
    def aboutGame(): #func in help menu
        messagebox.showinfo("About game", "This game is a mini project based in Python language (Python 3.11.0).")
    def howToPlay(): #func in help menu
        messagebox.showinfo("How to play","Refer to the rulebook")
...
def aboutGame(): 
    messagebox.showinfo("About", "This game is a mini project based in Python language (Python 3.11.0).")
def howToPlay(): 
    messagebox.showinfo("How to play","Refer the Rules Book")
help = Menu(menubar, tearoff=0)  
help.add_command(label="About game",command=aboutGame)
help.add_command(label="How to play",command=howToPlay)
help.add_command(label="Exit",command=root.quit)
